...
function create({ type, props, arrayItemType }) {
  ...
  function field(opts = {}) {
    ['input', 'name', 'label', 'classes', 'step', 'min', 'max', 'prefix', 'placeholder', 'legend', 'autocapitalize', 'autocomplete', 'form', 'itemOptions', 'multiple', 'autofocus', 'hideOptional', 'fieldVariant', 'variant', 'checkedVariant', 'selectedVariant', 'activeVariant', 'attributes']
