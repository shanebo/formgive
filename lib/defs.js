...
exports.address = (_options = countries, attributes) => {
  const requiredCondition = attributes
    && attributes.required
    && {
        required: true
      };
  const disabledCondition = attributes
    && attributes.disabled
    && {
        disabled: true
      };
...
exports.location = (_options = countries, _attributes) => {
  return {
    _label: 'Location',
    _input: 'location',
    _format: (val) => {
